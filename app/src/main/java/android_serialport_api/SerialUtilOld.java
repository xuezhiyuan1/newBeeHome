...
public class SerialUtilOld {
    ...
    /**
     85. * String的字符串转换成unicode的String
     86. * @param String strText 全角字符串
     87. * @return String 每个unicode之间无分隔符
     88. * @throws Exception
     89. */
    ...
    /**
     111. * unicode的String转换成String的字符串
     112. * @param String hex 16进制值字符串 （一个unicode为2byte）
     113. * @return String 全角字符串
     114. */
